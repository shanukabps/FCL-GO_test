...
//#include "MongoCertificate.h"
//#include "MongoArtifactData.h"
#include <set>
#include <algorithm>
#include <functional>
#include <math.h>
...
PENTITY Command::ExecuteIntCommand(MULONG ulCommand, PENTITY pEntity, PENTITY pArg)
{
    ...
    //print res values
//    std::cout<<"pIntRes = "<<pIntRes<<std::endl;
//    std::cout<<"pBoolRes = "<<pBoolRes<<std::endl;
//    std::cout<<"pNullRes = "<<pNullRes<<pStrRes<<std::endl;
//    std::cout<<"pStrRes = "<<pStrRes<<std::endl;
//    std::cout<<"--------------------------------------------------------------------"<<std::endl;
...
//                pNodeRes = tp->queryProfilesAndTDPs(pNode->GetLVal(), pNode->GetValue(), pNode->GetRVal(),
//                                                    pNode->GetCustomString());
//                break;
//            }
...
//                break;
//            }
//            case COMMAND_TYPE_QUERY_CERTIFICATES_BY_IDENTIFIERS: {
//                pNode = (PNODE) pArg;
//                MongoCertificate *mc = new MongoCertificate(80008);
//                pNodeRes = mc->queryByIdentifier(pNode->GetValue(), pNode->GetLVal());
//                break;
//            }
//            case COMMAND_TYPE_QUERY_VALID_CERTIFICATES_BY_LOCATION: {
//                pNode = (PNODE) pArg;
//                MongoCertificate *mc = new MongoCertificate(80009);
//                pNodeRes = mc->queryCertificatesForLocation(pNode->GetValue());
//                break;
//            }
//            case COMMAND_TYPE_QUERY_ARTIFACTDATA_BY_TEMPLATE: {
//                pNode = (PNODE) pArg;
//                MongoArtifactData *mad = new MongoArtifactData(80010);
//                pNodeRes = mad->queryByTemplateId(pNode->GetValue(), pNode->GetLVal());
//                break;
//            }
///////////////////////////////////////////////////////////////////////
